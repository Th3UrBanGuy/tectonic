...
import { Code, Bot, Shield, Zap, Briefcase, Globe, type LucideIcon } from "lucide-react";
...
const iconMap: Record<string, LucideIcon> = {
    Code, Bot, Shield, Zap, Briefcase, Globe,
};
...
const WingFeature = ({
    ...
    // Resolve icon: if string (from DB), look up in iconMap; if component (static), use directly
    const Icon = typeof wing.icon === "string"
        ? (iconMap[wing.icon as string] || Code)
        : (wing.icon as LucideIcon);
