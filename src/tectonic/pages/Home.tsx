...
const LightParticles = React.lazy(() => import('../components/home/LightParticles'));
...
const Home = () => {
  const { projects, homeContent, contentLoaded, isSectionVisible } = useContent();
  ...
  return (
    <>
          ...
          <div className="absolute inset-0 z-0 overflow-hidden">
            <div className="absolute inset-0 dark:hidden">
              <React.Suspense fallback={<div className="w-full h-full bg-white" />}>
                <LightParticles key="home-light-particles" />
              </React.Suspense>
            </div>
      ...
      {/* ── What We Deliver ──────────────────────────────────────────── */}
      {isSectionVisible('home', 'deliver') && <WhatWeDeliver />}

      {/* ── Ecosystem Grid ───────────────────────────────────────────── */}
      {isSectionVisible('home', 'wings') && (
      ...
      {/* ── Tech Stack ─────────────────────────────────────────────── */}
      {isSectionVisible('home', 'techStack') && <TechStackSection />}

      {/* ── Roadmap ────────────────────────────────────────────────── */}
      {isSectionVisible('home', 'roadmap') && <RoadmapSection />}

      {/* ── Partners ───────────────────────────────────────────────── */}
      {isSectionVisible('home', 'partners') && <PartnersSection />}
    </>
  );
};
