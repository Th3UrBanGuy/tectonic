...
const Contact = () => {
  ...
  const { contactConfig, contentLoaded, isSectionVisible } = useContent();
  ...
  const { address, contact, socials } = contactInfo;

  if (!contentLoaded) return <ContactSkeleton />;
                  ...
                  <Step>
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <input type="text" required value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} className="w-full bg-slate-50 dark:bg-black/50 border-2 border-slate-200 dark:border-gray-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white focus:border-purple-500 dark:focus:border-purple-500 focus:outline-none transition-colors" placeholder="John Doe" />
                      </div>
                      ...
                      <div>
                        ...
                        <input type="email" required value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} className="w-full bg-slate-50 dark:bg-black/50 border-2 border-slate-200 dark:border-gray-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white focus:border-purple-500 dark:focus:border-purple-500 focus:outline-none transition-colors" placeholder="john@company.com" />
                      </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input type="tel" value={formData.phone} onChange={e => setFormData({ ...formData, phone: e.target.value })} className="w-full bg-slate-50 dark:bg-black/50 border-2 border-slate-200 dark:border-gray-700 rounded-xl pl-12 pr-4 py-3 text-slate-900 dark:text-white focus:border-purple-500 dark:focus:border-purple-500 focus:outline-none transition-colors" placeholder="+1 (555) 000-0000" />
                        </div>
                      </div>
                    </div>
                  </Step>
                  ...
                  <Step>
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <input type="text" value={formData.company} onChange={e => setFormData({ ...formData, company: e.target.value })} className="w-full bg-slate-50 dark:bg-black/50 border-2 border-slate-200 dark:border-gray-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white focus:border-cyan-500 dark:focus:border-cyan-500 focus:outline-none transition-colors" placeholder="Acme Corporation" />
                      </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <select value={formData.department} onChange={e => setFormData({ ...formData, department: e.target.value })} className="w-full bg-slate-50 dark:bg-black/50 border-2 border-slate-200 dark:border-gray-700 rounded-xl pl-12 pr-4 py-3 text-slate-900 dark:text-white focus:border-cyan-500 dark:focus:border-cyan-500 focus:outline-none transition-colors appearance-none cursor-pointer">
                      ...
                      <div>
                        ...
                        <select value={formData.projectType} onChange={e => setFormData({ ...formData, projectType: e.target.value })} className="w-full bg-slate-50 dark:bg-black/50 border-2 border-slate-200 dark:border-gray-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white focus:border-cyan-500 dark:focus:border-cyan-500 focus:outline-none transition-colors appearance-none cursor-pointer">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <select value={formData.budget} onChange={e => setFormData({ ...formData, budget: e.target.value })} className="w-full bg-slate-50 dark:bg-black/50 border-2 border-slate-200 dark:border-gray-700 rounded-xl pl-12 pr-4 py-3 text-slate-900 dark:text-white focus:border-cyan-500 dark:focus:border-cyan-500 focus:outline-none transition-colors appearance-none cursor-pointer">
                  ...
                  <Step>
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <textarea rows={6} required value={formData.message} onChange={e => setFormData({ ...formData, message: e.target.value })} className="w-full bg-slate-50 dark:bg-black/50 border-2 border-slate-200 dark:border-gray-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white focus:border-orange-500 dark:focus:border-orange-500 focus:outline-none transition-colors resize-none" placeholder="Describe your project requirements, goals, timeline, and any specific challenges you're facing..." />
                      </div>
                      ...
                      {isSubmitting && (
                        <div className="p-4 bg-cyan-50 dark:bg-cyan-500/10 border border-cyan-200 dark:border-cyan-500/30 rounded-xl flex items-center gap-3">
                          <div className="w-4 h-4 border-2 border-cyan-500 border-t-transparent rounded-full animate-spin" />
                          <p className="text-sm text-cyan-700 dark:text-cyan-400 font-medium">Transmitting your message...</p>
                        </div>
                      )}
                    </div>
                  </Step>
